...
class LLMService:
    ...
    async def generate_digest(self, news: List[Dict], coins: List[str]) -> Optional[str]:
        """
...
Be direct and practical. Start with the most important insight."""
    ...
    async def analyze_portfolio(self, holdings: List[Dict], market_data: Dict) -> Optional[Dict]:
        """
        Portföy AI analizi
...
{{
  "analyses": [
    ...
    async def generate_coin_analysis(self, symbol: str, data: Dict) -> Optional[Dict]:
        """
